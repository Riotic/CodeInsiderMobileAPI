...
public class EditPostEtudiant {
    ...
    public EditPostEtudiant(String email, String firstname, String name, String birthday, String localization, String curriculum_year, String requested_remuneration, String skills, String contract_type, String contract_time, String phone_number) {
        this.email = email;
